...
const SerialNumber = ({ warehouse, product, state, setState, setClose }) => {
    ...
    const inputConfig = [
        { field: 'sn', id: 'serial', useRef: refFocus, type: 'number', label: 'Número de serie', disabled: disabled && !edit, state: newSerialNumber, setState: setNewSerialNumber, expression: 'digitsRegExp', css: 'w-1/3' },
    ...
    const addSerialNumber = () => {
        ...
        if (newSerialNumber.error === false && newMac1.error === false && newMac2.error === false && newMac3.error === false && newEn.error === false) {
                ...
                <div className='flex flex-col item gap-5 bg-white w-11/12 sm:w-4/5 lg:w-3/5 p-5 rounded-3xl'>
                    ...
                    {!!idSelected &&
                        <div className='flex gap-2 justify-end pt-5'>
                            <Button customFunction={() => { }} borderColor='black' color='black' backgroundColor='transparent' width='12/6' height='normal' text='Cancelar' />
