...
const Clock = () => {
    ...
    return (
        <div className='min-w-fit w-full flex-1 sm:w-1/3 h-36 flex flex-col gap-2 items-center justify-center rounded-lg py-5 px-4 bg-gradient-to-br from-[#161ECF] to-[#571CDD] text-white shadow-xl'>
