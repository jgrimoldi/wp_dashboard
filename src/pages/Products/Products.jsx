...
const Products = () => {
  ...
  const inputConfig = [
    ...
    { getter: 'nombre', getterField: 'fk_tipoproducto', url: URL_PRODUCTTYPE, id: 'type', label: 'Tipo de producto', state: newProductType, setState: setNewProductType, expression: 'notEmpty', css: 'w-5/6 sm:w-1/6' },
    { field: 'cantidad', id: 'quantity', type: 'number', label: 'Unidades', state: newQuantity, setState: setNewQuantity, expression: 'digitsRegExp', css: 'w-2/12' },
    { getter: 'magnitud', getterField: 'fk_unidad', url: URL_UNIT, id: 'unit', label: 'Unidad de medida', state: newUnit, setState: setNewUnit, expression: 'notEmpty', css: 'w-2/12' },
    { field: 'stockmin', id: 'min', type: 'number', label: 'Stock mínimo', state: newMin, setState: setNewMin, expression: 'digitsRegExp', css: 'w-1/6' },
    { field: 'stockmax', id: 'max', type: 'number', label: 'Stock máximo', state: newMax, setState: setNewMax, expression: 'digitsRegExp', css: 'w-1/6' },
    { getter: 'alicuota', getterField: 'fk_alicuota', url: URL_VAT, id: 'alicuota', label: 'Alicuota', state: newAlicuota, setState: setNewAlicuota, expression: 'notEmpty', css: 'w-1/3 sm:w-[12%]' },
    { field: 'controlNS', id: 'ns', type: 'checkbox', label: 'Control NS', state: hasNS, setState: setHasNs, expression: 'notEmpty', css: 'w-1/11 flex items-center' },
